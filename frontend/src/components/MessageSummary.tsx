      ...
      <div className="p-6">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          ...
          <div className="space-y-4">
            <h3 className="font-medium text-gray-900 dark:text-white">Message Statistics</h3>
            <div className="space-y-3">
              <div className="flex items-center justify-between">
                <span className="text-sm text-gray-600 dark:text-gray-400">Total Messages</span>
                <span className="font-semibold text-gray-900 dark:text-white">{insights.totalMessages}</span>
              </div>
              <div className="flex items-center justify-between">
                <span className="text-sm text-gray-600 dark:text-gray-400">Important Messages</span>
                <span className="font-semibold text-red-600 dark:text-red-400">{insights.importantMessages}</span>
              </div>
              <div className="flex items-center justify-between">
                <span className="text-sm text-gray-600 dark:text-gray-400">Avg Response Time</span>
                <span className="font-semibold text-green-600 dark:text-green-400">{insights.averageResponseTime}</span>
              </div>
            </div>
          </div>
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-3">
              <div>
                <span className="text-sm text-gray-600 dark:text-gray-400">Most Active Chat</span>
          ...
          {/* Top Keywords */}
          <div className="space-y-4">
            <h3 className="font-medium text-gray-900 dark:text-white">Trending Topics</h3>
            <div className="flex flex-wrap gap-2">
              {insights.topKeywords.map((keyword, index) => (
                <span
                  key={index}
                  className="px-3 py-1 bg-indigo-100 dark:bg-indigo-900/30 text-indigo-800 dark:text-indigo-300 text-sm rounded-full"
                >
                  {keyword}
                </span>
              ))}
