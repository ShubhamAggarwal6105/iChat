      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 lg:py-32">
        <div className="text-center">
          ...
          <p className="text-xl md:text-2xl text-gray-600 mb-12 max-w-4xl mx-auto leading-relaxed">
            Filter noise, highlight importance, and enhance communication with AI-powered 
            intelligent messaging designed for modern community groups.
          </p>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
            ...
            <button className="border-2 border-gray-300 text-gray-700 px-8 py-4 rounded-lg hover:border-indigo-600 hover:text-indigo-600 transition-all duration-300 text-lg font-semibold">
              Watch Demo
            </button>
          </div>
          ...
          <div className="mt-16 pt-8 border-t border-gray-200">
            <p className="text-gray-500 text-sm mb-6">Trusted by communities worldwide</p>
            <div className="flex flex-wrap justify-center items-center gap-8 opacity-60">
              <div className="text-2xl font-bold text-gray-400">Green Meadows</div>
              <div className="text-2xl font-bold text-gray-400">Tech Hub</div>
              <div className="text-2xl font-bold text-gray-400">Student Union</div>
              <div className="text-2xl font-bold text-gray-400">Neighborhood Watch</div>
            </div>
          </div>
        </div>
      </div>
