  ...
  const faqs = [
    {
      ...
      answer: "iChat works as an intelligent wrapper around popular platforms like Telegram and WhatsApp. You continue using your preferred chat applications, while iChat enhances them with AI-powered features like filtering, summarization, and smart replies. Our integration is seamless and doesn't require changing your existing workflow."
    },
    {
      question: "What makes iChat's AI filtering different from simple keyword searches?",
      answer: "Our advanced NLP (Natural Language Processing) algorithms understand context, sentiment, and relevance rather than just matching keywords. This means iChat can identify important messages even when they don't contain obvious keywords, and it learns from your community's communication patterns to improve accuracy over time."
    },
    {
      question: "How accurate is the fake news detection feature?",
      answer: "Our multi-modal AI system combines text analysis, source verification, and pattern recognition to achieve 95% accuracy in detecting potentially false information. The system is continuously updated with the latest misinformation patterns and works across multiple languages and content types."
    },
    {
      question: "Can iChat handle large community groups with thousands of members?",
      answer: "Absolutely! iChat is designed to scale from small neighborhood groups to large communities with thousands of members. Our infrastructure can process millions of messages daily while maintaining real-time performance. Larger communities actually benefit more from our AI features due to the higher volume of content to filter and organize."
    },
    {
      question: "How does the calendar scheduling feature work?",
      answer: "iChat automatically scans your group messages for date/time references, meeting invites, and event mentions. It extracts this information using advanced text processing and creates calendar entries with relevant details. You can review and approve these entries before they're added to your calendar, ensuring accuracy and control."
    },
    {
    ...
    },
    {
      ...
      answer: "Getting started is incredibly simple! Most communities are up and running within 5 minutes. Just sign up, connect your existing messaging platform (Telegram or WhatsApp), and our AI immediately begins analyzing and enhancing your communications. No complex setup or technical expertise required."
    },
    {
      question: "Does iChat work in multiple languages?",
      answer: "Yes! iChat supports over 50 languages and can handle multilingual communities seamlessly. Our AI understands context and nuance across different languages, and features like summarization and filtering work effectively regardless of the primary language used in your community."
    }
  ];
