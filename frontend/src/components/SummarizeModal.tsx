...
import { Chat, SummaryOptions } from '../types';
      ...
      <div className="bg-white rounded-xl p-6 w-full max-w-2xl mx-4 max-h-[90vh] overflow-y-auto">
        <div className="flex items-center justify-between mb-6">
          <div className="flex items-center space-x-2">
            ...
            <h2 className="text-xl font-semibold text-gray-900">AI Summarization</h2>
          </div>
          <button
            onClick={onClose}
        ...
        <button
          ...
          className="w-full bg-purple-600 text-white py-3 rounded-lg hover:bg-purple-700 disabled:opacity-50 disabled:cursor-not-allowed mb-6 flex items-center justify-center space-x-2"
        >
          {isGenerating ? (
            <>
