      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {testimonials.map((testimonial, index) => (
            <div
              key={index}
              className="bg-gray-50 rounded-2xl p-8 hover:bg-gray-100 transition-all duration-300 transform hover:-translate-y-1 relative group"
            >
              {/* Quote Icon */}
              <Quote className="absolute top-6 right-6 w-8 h-8 text-indigo-200 group-hover:text-indigo-300 transition-colors" />
              ...
              <div className="flex items-center">
                ...
                <div>
                  ...
                  <p className="text-sm text-indigo-600 font-medium">{testimonial.community}</p>
                </div>
              </div>
            </div>
          ))}
        ...
        <div className="mt-20 grid grid-cols-2 md:grid-cols-4 gap-8 text-center">
          <div className="group">
            <div className="text-4xl font-bold text-indigo-600 mb-2 group-hover:scale-110 transition-transform">98%</div>
            <div className="text-gray-600">Satisfaction Rate</div>
          </div>
          <div className="group">
            <div className="text-4xl font-bold text-indigo-600 mb-2 group-hover:scale-110 transition-transform">1000+</div>
            <div className="text-gray-600">Active Communities</div>
          </div>
          <div className="group">
            <div className="text-4xl font-bold text-indigo-600 mb-2 group-hover:scale-110 transition-transform">70%</div>
            <div className="text-gray-600">Time Saved</div>
          </div>
          <div className="group">
            <div className="text-4xl font-bold text-indigo-600 mb-2 group-hover:scale-110 transition-transform">24/7</div>
